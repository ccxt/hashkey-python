...
- `create_swap_order_request(self, symbol: Str, type: Str, side: Str, amount: Num, price: Num = None, params={})`
...
- `check_type_param(self, methodName: Any, params: Any)`
- `custom_urlencode(self, params: dict = {})`
- `describe(self)`
- `encode_account_type(self, type: Any)`
- `encode_flow_type(self, type: Any)`
...
- `watch_private(self, messageHash: Any)`
- `get_private_url(self, listenKey: Any)`
...
- `set_balance_cache(self, client: Client, type: Any, subscribeHash: Any)`
- `load_balance_snapshot(self, client: Client, messageHash: Any, type: Any)`
- `authenticate(self, params={})`
- `keep_alive_listen_key(self, listenKey: Any, params={})`
