...
- `check_type_param(self, methodName: object, params: object)`
...
- `set_balance_cache(self, client: Client, type: object, subscribeHash: object)`
- `load_balance_snapshot(self, client: Client, messageHash: object, type: object)`
- `authenticate(self, params={})`
- `keep_alive_listen_key(self, listenKey: object, params={})`
